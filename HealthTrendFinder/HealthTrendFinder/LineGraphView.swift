...
class LineGraphView: UIView {
    ...
    @IBInspectable var xGraphArea: CGFloat = 60
    @IBInspectable var yGraphArea: CGFloat = 60
    ...
    @IBInspectable var xLabelSize: CGFloat = 5
    @IBInspectable var yLabelSize: CGFloat = 5
    ...
    private func determineGraphingAreaDimensions() {
        let rWidth: CGFloat = self.bounds.width * xGraphArea / 100
        let rHeight: CGFloat = self.bounds.height * yGraphArea / 100
        let rX: CGFloat = (self.bounds.width - rWidth) * 0.5
        let rY: CGFloat = (self.bounds.height - rHeight) * 0.5
    ...
    private func horizontalGridLine(y: CGFloat) {
        ...
        let text: NSString = (prelimText as NSString)
        let textRect: CGRect = CGRectMake(0,
            translateY(y, windowRef: data[0].window) - yLabelSize / 100 * self.bounds.height * 0.5,
            (self.bounds.width - graphingArea.width) * 0.5 - yLabelMargin / 100 * self.bounds.height,
    ...
    private func verticalGridLine(x: CGFloat) {
        ...
        let text: NSString = (prelimText as NSString)
        let xLabelMarginAbsolute = xLabelMargin / 100 * self.bounds.height
